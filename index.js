...
const rotationValues = [
    { minDegree: 0, maxDegree: 30, value: 'Singha' },
    { minDegree: 31, maxDegree: 90, value: 'Tiger' },
    { minDegree: 91, maxDegree: 150, value: 'Smooth' },
    { minDegree: 151, maxDegree: 210, value: 'GR Blue' },
    { minDegree: 211, maxDegree: 270, value: 'Tuborg' },
    { minDegree: 271, maxDegree: 330, value: 'ABC' },
    { minDegree: 331, maxDegree: 360, value: 'ABC' },
];
...
let myChart = new Chart(wheel, {
    ...
    data: {
        // Values on chart
        labels: ['Tiger', 'Singha', 'ABC', 'Tuborg','GR Blue', 'Smooth'],
        datasets: [
            {
